...
def dict_basics_2():
    ...
    capital = capitals.pop(
        "Germany", "München"
    )  # this pop() methods prevents KeyError
...
def dict_basics_3():
    ...
    trainings = {
        "course1": {
            "title": "Python Training Course for Beginners",
            "location": "Frankfurt",
    ...
    trainings["course2"] = {
        "title": "Perl Seminar for Beginners",
        "location": "Ulm",
    ...
    for key in d.keys():
        print(
            key, d[key], end=" "
        )  # accessing as d[key] is less efficient than iterating over d.values()
