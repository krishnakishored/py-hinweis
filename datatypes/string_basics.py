...
def string_basics_2():
    ...
    print("what's happened to ted's IBM stock?".title()) # What'S Happened To Ted'S Ibm Stock?
...
def string_basics_3():
    ...
    '''
    print('foo bar foo baz foo qux'.replace('foo', 'grault', 2)) # grault bar grault baz foo qux
    ...
    print('www.realpython.com'.rsplit(sep='.', maxsplit=1)) # ['www.realpython', 'com']
    print('www.realpython.com'.split('.', maxsplit=1)) # ['www', 'realpython.com']
