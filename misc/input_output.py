...
def giving_output():
    ...
    print("art:%5d,Price per Unit:%8.2f" % (453,59.098)) # art:  453,Price per Unit:   59.10
    print("%5.4x"% (47)) #  002f
    ...
    print("The capital of {0:s} is {1:s}".format("Ontario","Toronto")) #We could have used empty curly braces
...
def giving_output_fstrings():
    ...
    print(F'Hello {name}, you are age is {age}') # Hello Eric, you are age is 74
    ...
    print(f"{new_comedian!r}") # __repr__(self) is called # Eric Idle is 74. Surprise!
